...
export const profile = {
    ...
    summary:
        "นิสิตวิศวกรรมคอมพิวเตอร์ที่มีความมุ่งมั่นในการพัฒนาซอฟต์แวร์แบบ Full-Stack และชื่นชอบในการนำข้อมูลมาสร้างมูลค่าเพิ่ม (Data & AI) ปัจจุบันมีประสบการณ์ทั้งการพัฒนา Web Application ตั้งแต่การออกแบบ UI ไปจนถึงการทำ Deployment และกำลังต่อยอดทักษะด้าน Backend Architecture ควบคู่ไปกับการทำโปรเจกต์วิจัยเชิงสถิติและการประยุกต์ใช้ Machine Learning เพื่อแก้ปัญหาจริง ผมให้ความสำคัญกับการเรียนรู้เทคโนโลยีใหม่ ๆ อย่างสม่ำเสมอ และกำลังมองหาโอกาสในการฝึกงานเพื่อนำทักษะทางวิศวกรรมมาสร้างอิมแพคในสภาพแวดล้อมการทำงานจริง",
    skills: [
